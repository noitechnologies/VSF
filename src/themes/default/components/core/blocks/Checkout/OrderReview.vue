...
&nbsp;
    ...
    <modal name="modal-terms">
      ...
      <div slot="content">
        <p>
          This website ("website") is operated by Sportires Inc., which includes Sportires stores, and Sportires Private Sales. This privacy policy only covers information collected at this website, and does not cover any information collected offline by Sportires. All Sportires websites are covered by this privacy policy.
        </p>
        <h2>
          Sportires Security
        </h2>
        ...
        <p>
          As we continue to develop the Sportires website and take advantage of advances in technology to improve the services we offer, this privacy policy likely will change. We therefore encourage you to refer to this policy on an ongoing basis so that you understand our current privacy policy.
        </p>
      </div>
    </modal>
  </div>

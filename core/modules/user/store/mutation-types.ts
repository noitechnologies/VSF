...
export const USER_PRODUCT_REVIEWS_LOADED = SN_USER + '/PRODUCT_REVIEWS_LOADED'
export const USER_WISHLIST_LOADED = SN_USER + '/WISHLIST_LOADED'
export const USER_WISHLIST_ITEM_ADDED = SN_USER + '/WISHLIST_ITEM_ADDED'
export const USER_WISHLIST_ITEM_REMOVED = SN_USER + '/WISHLIST_ITEM_REMOVED'
export const USER_WISHLIST_CLEARED = SN_USER + '/WISHLIST_CLEARED'
